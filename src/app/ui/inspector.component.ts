            ...
            <div class="p-5 space-y-4">
               <div class="grid grid-cols-2 gap-3">
                 <div class="p-3 bg-white/5 rounded-xl border border-white/5 space-y-1">
                    <span class="text-[8px] text-slate-500 uppercase font-black tracking-tighter">Width</span>
                    <input type="number" step="0.1" [value]="s.width" (input)="updateEntityWidth(id, $any($event.target).value)" 
                      class="w-full bg-transparent border-none p-0 text-lg font-mono font-bold text-white outline-none">
                 </div>
                 <div class="p-3 bg-white/5 rounded-xl border border-white/5 space-y-1">
                    <span class="text-[8px] text-slate-500 uppercase font-black tracking-tighter">Height</span>

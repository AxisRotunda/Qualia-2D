        ...
        <div class="bg-indigo-600/10 p-6 rounded-[2.5rem] border border-indigo-500/20 space-y-4 shadow-xl">
           <div class="flex items-center gap-3">
              ...
              <div class="flex flex-col">
                <span class="text-[8px] text-indigo-400 font-black uppercase tracking-widest">Active_Fragment</span>
                <span class="text-white font-black tracking-tighter uppercase">{{ scene.name }}</span>
              </div>
           </div>
           
           <div class="space-y-1">
             <label class="text-[8px] text-slate-500 uppercase font-black tracking-widest px-1">Fragment Alias</label>
        ...
        <div class="bg-slate-900/40 backdrop-blur-md rounded-[2.5rem] border border-white/5 overflow-hidden">
            <div class="px-6 py-5 bg-white/5 flex items-center justify-between border-b border-white/5">
               <div class="flex items-center gap-3">
                 ...
                 <span class="text-[9px] font-black uppercase tracking-widest text-white">Environmental_Core</span>
               </div>
            </div>
            <div class="p-6 space-y-6">
               <!-- Background Color -->
               <div class="space-y-3">
                  <span class="text-[8px] text-slate-500 uppercase font-black tracking-widest px-1">Void_Chroma</span>
               ...
               <div class="p-4 bg-slate-950/40 rounded-2xl border border-white/5 space-y-3">
                  <div class="flex items-center justify-between">
                    <span class="text-[8px] text-slate-500 uppercase font-black tracking-tighter">Planar_Grid_Alpha</span>
                    <span class="text-[10px] font-mono text-white">{{ state.envConfig().gridOpacity | number:'1.2-2' }}</span>
                  </div>
        ...
        <div class="bg-slate-900/40 backdrop-blur-md rounded-[2.5rem] border border-white/5 overflow-hidden">
            <div class="px-6 py-5 bg-white/5 flex items-center justify-between border-b border-white/5">
               <div class="flex items-center gap-3">
                 ...
                 <span class="text-[9px] font-black uppercase tracking-widest text-white">Global_Dynamics</span>
               </div>
            </div>
            <div class="p-6 space-y-6">
               <div class="p-4 bg-slate-950/40 rounded-2xl border border-white/5 space-y-3">
                  <div class="flex items-center justify-between">
                    <span class="text-[8px] text-slate-500 uppercase font-black tracking-tighter">Gravity_Y_Flux</span>
                    <span class="text-[10px] font-mono text-white">{{ state.gravityY() | number:'1.1-1' }}</span>
                  </div>
